...
HD_PWD='C:/Users/Ponce/Desktop/proyecto_final_el_bueno/proyecto_final_el_bueno.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log datapathGCD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source datapathGCD.tcl

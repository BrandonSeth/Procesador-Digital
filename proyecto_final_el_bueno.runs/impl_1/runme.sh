...
HD_PWD='C:/Users/Ponce/Desktop/proyecto_final_el_bueno/proyecto_final_el_bueno.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log datapathGCD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source datapathGCD.tcl -notrace

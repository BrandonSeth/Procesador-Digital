...
HD_PWD='C:/Users/Ponce/Desktop/finalAlfin/finalAlfin.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MCD_MCM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MCD_MCM.tcl -notrace

...
HD_PWD='C:/Users/Ponce/Desktop/finalAlfin/finalAlfin.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MCD_MCM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MCD_MCM.tcl
